...
const pointTypes = () => [{
  ...
  'offers': [{
    ...
    'id': 17,
    'title': 'Excursion to the waterfall',
    'price': 500
  }]
}, {
  'type': 'sightseeing',
...
/* harmony import */ var _point_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./point-types */ "./src/mock/point-types.js");
...
const generatePoint = () => {
  ...
  const locationArray = (0,_locations__WEBPACK_IMPORTED_MODULE_1__.locations)();
  const pointArray = (0,_point_types__WEBPACK_IMPORTED_MODULE_2__.pointTypes)();
  return {
...
class FilterModel extends _utils_abstract_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    ...
    _classPrivateFieldInitSpec(this, _filter, {
      writable: true,
      value: _utils_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING
    });
...
/* harmony export */ });
/* harmony import */ var _utils_abstract_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/abstract-observable */ "./src/utils/abstract-observable.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class PointsModel extends _utils_abstract_observable__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "deletePoint", (updateType, update) => {
      const index = _classPrivateFieldGet(this, _points).findIndex(task => task.id === update.id);
...
/* harmony export */ });
/* harmony import */ var _view_trip_filters_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/trip-filters-view */ "./src/view/trip-filters-view.js");
...
var _tasksModel = /*#__PURE__*/new WeakMap();
...
class FilterPresenter {
  constructor(filterContainer, filterModel, tasksModel) {
    ...
    _classPrivateFieldInitSpec(this, _tasksModel, {
      writable: true,
      value: null
    });
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _filterComponent, new _view_trip_filters_view__WEBPACK_IMPORTED_MODULE_0__["default"](filters, _classPrivateFieldGet(this, _filterModel).filter));
    ...
    _classPrivateFieldInitSpec(this, _handleFilterTypeChange, {
      ...
      value: filterType => {
        ...
        _classPrivateFieldGet(this, _filterModel).setFilter(_utils_const__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MAJOR, filterType);
      }
    });
    ...
    _classPrivateFieldSet(this, _tasksModel, tasksModel);
...
/* harmony import */ var _utils_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const */ "./src/utils/const.js");
/* harmony import */ var _view_event_add_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/event-add-view.js */ "./src/view/event-add-view.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _pointAddComponent = /*#__PURE__*/new WeakMap();
...
class PointNewPresenter {
  constructor(pointListContainer, changeData) {
    ...
    _classPrivateFieldInitSpec(this, _pointAddComponent, {
      writable: true,
      value: null
    });

    _defineProperty(this, "init", () => {
      if (_classPrivateFieldGet(this, _pointAddComponent) !== null) {
        return;
      }

      _classPrivateFieldSet(this, _pointAddComponent, new _view_event_add_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]());

      _classPrivateFieldGet(this, _pointAddComponent).setFormSubmitHandler(_classPrivateFieldGet(this, _handleFormSubmit));

      _classPrivateFieldGet(this, _pointAddComponent).setDeleteClickHandler(_classPrivateFieldGet(this, _handleDeleteClick));

      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _pointListContainer), _classPrivateFieldGet(this, _pointAddComponent), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
    ...
    _defineProperty(this, "destroy", () => {
      ...
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _pointAddComponent));

      _classPrivateFieldSet(this, _pointAddComponent, null);
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const__WEBPACK_IMPORTED_MODULE_1__.UserAction.ADD_POINT, _utils_const__WEBPACK_IMPORTED_MODULE_1__.UpdateType.MINOR, //Без сервера берутся числа самостоятельно
        {
          id: (0,nanoid__WEBPACK_IMPORTED_MODULE_3__.nanoid)(),
          ...task
        });
...
/* harmony import */ var _utils_favorite__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/favorite */ "./src/utils/favorite.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class PointPresenter {
  constructor(tripPointsListElement, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _handleFavoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_TASK, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, { ..._classPrivateFieldGet(this, _tripPoint),
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: update => {
        const isMinorUpdate = !(0,_utils_favorite__WEBPACK_IMPORTED_MODULE_4__.isDatesEqual)(_classPrivateFieldGet(this, _tripPoint).dateFrom, update.dateFrom) || !(0,_utils_favorite__WEBPACK_IMPORTED_MODULE_4__.isDatesEqual)(_classPrivateFieldGet(this, _tripPoint).dateTo, update.dateTo) || _classPrivateFieldGet(this, _tripPoint).basePrice !== update.basePrice;

        _classPrivateFieldGet(this, _changeData).call(this, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, isMinorUpdate ? _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR : _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.PATCH, update);
    ...
    _classPrivateFieldInitSpec(this, _handleDeleteClick, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.DELETE_POINT, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, task);
      }
    });
...
/* harmony import */ var _point_new_presenter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./point-new-presenter */ "./src/presenter/point-new-presenter.js");
...
var _renderTripPoints = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(mainElement, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _filterType, {
      writable: true,
      value: _utils_const__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING
    });
    ...
    _defineProperty(this, "createPoint", () => {
      _classPrivateFieldSet(this, _currentSortType, _utils_const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY);

      _classPrivateFieldGet(this, _filterModel).setFilter(_utils_const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MAJOR, _utils_const__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING);
    ...
    _classPrivateFieldInitSpec(this, _renderNoTasks, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _noTripPointsComponent, new _view_no_trip_points_view__WEBPACK_IMPORTED_MODULE_2__["default"](_classPrivateFieldGet(this, _filterType)));
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _utils_const__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_POINT:
            _classPrivateFieldGet(this, _pointsModel).updatePoint(updateType, update);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_6__.UserAction.ADD_POINT:
            _classPrivateFieldGet(this, _pointsModel).addPoint(updateType, update);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_6__.UserAction.DELETE_POINT:
    ...
    _classPrivateFieldInitSpec(this, _handleModelEvent, {
      ...
      value: (updateType, data) => {
        switch (updateType) {
          case _utils_const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.PATCH:
            _classPrivateFieldGet(this, _pointPresenter).get(data.id).init(data);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MINOR:
            _classPrivateFieldGet(this, _clearMain).call(this);

            _classPrivateFieldGet(this, _renderMain).call(this);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MAJOR:
            _classPrivateFieldGet(this, _clearMain).call(this, {
    ...
    _classPrivateFieldInitSpec(this, _handleSortTypeChange, {
      ...
      value: sortType => {
        ...
        _classPrivateFieldGet(this, _renderTripPoints).call(this, this.points);
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_trip_sort_view__WEBPACK_IMPORTED_MODULE_3__["default"](_classPrivateFieldGet(this, _currentSortType)));

        _classPrivateFieldGet(this, _sortComponent).setSortTypeChangeHandler(_classPrivateFieldGet(this, _handleSortTypeChange));

        (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripPointsElement), _classPrivateFieldGet(this, _sortComponent), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripPoint, {
      writable: true,
      value: point => {
        const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _tripPointsListElement), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _renderTripPoints, {
      writable: true,
      value: points => {
        points.forEach(point => _classPrivateFieldGet(this, _renderTripPoint).call(this, point));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _clearMain, {
      ...
      value: ({
        ...
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _sortComponent));

        if (resetSortType) {
          _classPrivateFieldSet(this, _currentSortType, _utils_const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY);
        }

        if (_classPrivateFieldGet(this, _noTripPointsComponent)) {
          (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _noTripPointsComponent));
        }
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderMain, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _renderTripPoints).call(this, points);
      }
    });
    ...
    _classPrivateFieldSet(this, _pointNewPresenter, new _point_new_presenter__WEBPACK_IMPORTED_MODULE_5__["default"](_classPrivateFieldGet(this, _tripPointsListElement), _classPrivateFieldGet(this, _handleViewAction)));
  ...
  get points() {
    ...
    switch (_classPrivateFieldGet(this, _currentSortType)) {
      case _utils_const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_7__.sortTaskByDay);

      case _utils_const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_TIME:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_7__.sortTaskByDuration);

      case _utils_const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_PRICE:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_7__.sortTaskByPrice);
    }
...
const isDatesEqual = (dateA, dateB) => dateA === null && dateB === null || dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB); //common
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.FUTURE]: points => points.filter(point => new Date(point.dateFrom) > new Date()),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PAST]: points => points.filter(point => new Date(point.dateTo) < new Date())
};
...
/* harmony import */ var _mock_locations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/locations */ "./src/mock/locations.js");
/* harmony import */ var _mock_point_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mock/point-types */ "./src/mock/point-types.js");
...
const createPointAddTemplate = point => {
  ...
  const eventTypesMarkup = (0,_utils_path__WEBPACK_IMPORTED_MODULE_4__.createPointTypesMarkup)((0,_mock_point_types__WEBPACK_IMPORTED_MODULE_3__.pointTypes)(), type);
  const locationOptions = (0,_mock_locations__WEBPACK_IMPORTED_MODULE_2__.locations)().map(x => `<option value="${x.name}"></option>`).join('');

  const createPhotosMarkup = dest => {
    if (dest.pictures.length > 0) {
      return dest.pictures.map(x => `<img class="event__photo" src="${x.src}" alt="${x.description}">`).join('');
    }
  ...
  const editedOffersMarkup = (0,_utils_path__WEBPACK_IMPORTED_MODULE_4__.createOffersSectionMarkup)((0,_mock_point_types__WEBPACK_IMPORTED_MODULE_3__.pointTypes)(), type);
  ...
  <form class="event event--edit" action="#" method="post">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--destination">
        ...
        <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(destination.name ? destination.name : '')}" list="destination-list-1">
      ...
      <div class="event__field-group  event__field-group--price">
        ...
        <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(price ? price.toString() : '')}">
      </div>
...
class EventAddView extends _smart_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(_point) {
    super();
    ...
    _defineProperty(this, "reset", point => {
      this.updateData(EventAddView.parsePointToData(point));
    });

    _classPrivateFieldInitSpec(this, _setDatepicker, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _datepickerFrom, (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])(this.element.querySelector('.event__input-start-time'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
          defaultDate: this._data.dateFrom,
          onChange: _classPrivateFieldGet(this, _dateFromChangeHandler)
        }));

        _classPrivateFieldSet(this, _datepickerTo, (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])(this.element.querySelector('.event__input-end-time'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
    ...
    _classPrivateFieldInitSpec(this, _getChangedDestination, {
      writable: true,
      value: locationName => {
        const allLocations = (0,_mock_locations__WEBPACK_IMPORTED_MODULE_2__.locations)();
    ...
    this._data = EventAddView.createEmptyPoint(_point);
...
_defineProperty(EventAddView, "createEmptyPoint", () => {
  const offerArray = (0,_mock_point_types__WEBPACK_IMPORTED_MODULE_3__.pointTypes)();
  const date = new Date();
  return {
    basePrice: null,
...
_defineProperty(EventAddView, "parsePointToData", point => ({ ...point // В будущем здесь появится обработка Предложений (Offers).

}));

_defineProperty(EventAddView, "parseDataToPoint", data => {
  const point = { ...data
...
const NoPointsTextType = {
  [_utils_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING]: 'Click New Event to create your first point',
  [_utils_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST]: 'There are no past events now',
  [_utils_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE]: 'There are no future events now'
};
...
/* harmony export */ });
/* harmony import */ var _mock_locations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mock/locations */ "./src/mock/locations.js");
/* harmony import */ var _mock_point_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mock/point-types */ "./src/mock/point-types.js");
/* harmony import */ var _smart_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./smart-view */ "./src/view/smart-view.js");
/* harmony import */ var _utils_path__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/path */ "./src/utils/path.js");
...
const createPointEditTemplate = point => {
  ...
  const pointTypesMarkup = (0,_utils_path__WEBPACK_IMPORTED_MODULE_3__.createPointTypesMarkup)((0,_mock_point_types__WEBPACK_IMPORTED_MODULE_1__.pointTypes)(), type);
  const destinationOptions = (0,_mock_locations__WEBPACK_IMPORTED_MODULE_0__.locations)().map(x => `<option value="${x.name}"></option>`).join(''); // const photosMarkup = destination.pictures.map((x) => (`<img class="event__photo" src="${x.src}" alt="${x.description}">`)).join('');

  const photosMarkup = picture => `<img class="event__photo" src="${picture.src}" alt="Event photo">`;

  const editedOffersMarkup = (0,_utils_path__WEBPACK_IMPORTED_MODULE_3__.createOffersSectionMarkup)((0,_mock_point_types__WEBPACK_IMPORTED_MODULE_1__.pointTypes)(), type);
  return `<li class="trip-events__item">
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  <div class="event__type-wrapper">
                  ...
                  <div class="event__field-group  event__field-group--destination">
                    ...
                    <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(destination.name)}" list="destination-list-1">
                    <datalist id="destination-list-1">
                      ${destinationOptions}
                    </datalist>
                  </div>
                  ...
                  <div class="event__field-group  event__field-group--price">
                    ...
                    <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(price.toString())}">
                  </div>
                  <button class="event__save-btn  btn  btn--blue" type="submit">Save</button>
...
var _getChangedLocation = /*#__PURE__*/new WeakMap();

class PointEditView extends _smart_view__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(_point) {
    super();
    ...
    _classPrivateFieldInitSpec(this, _setDatepicker, {
      ...
      value: () => {
        ...
        _classPrivateFieldSet(this, _datepickerTo, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.element.querySelector('.event__input-end-time'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
          defaultDate: this._data.dateTo,
          onChange: _classPrivateFieldGet(this, _dateToChangeHandler)
    ...
    _classPrivateFieldInitSpec(this, _destinationChangeHandler, {
      ...
      value: evt => {
        evt.preventDefault();
        this.updateData({
          location: _classPrivateFieldGet(this, _getChangedLocation).call(this, evt.target.value)
        }, false);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _getChangedLocation, {
      writable: true,
      value: locationName => {
        const allLocations = (0,_mock_locations__WEBPACK_IMPORTED_MODULE_0__.locations)();
...
_defineProperty(PointEditView, "parsePointToData", point => ({ ...point // to be continue
...
const createPointTemplate = point => {
  ...
  const OffersMarkup = CreateOffers(type, (0,_mock_point_types__WEBPACK_IMPORTED_MODULE_2__.pointTypes)());
  return `<li class="trip-events__item">
              <div class="event">
...
class PointItemView extends _abstract_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(point) {
    super();
...
const createFilterItemTemplate = (type, currentFilterType) => `<div class="trip-filters__filter">
...
const createTripSortTemplate = sortType => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
...
/* harmony import */ var _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/trip-presenter */ "./src/presenter/trip-presenter.js");
/* harmony import */ var _presenter_filter_presenter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/filter-presenter.js */ "./src/presenter/filter-presenter.js");
/* harmony import */ var _mock_trip_point__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mock/trip-point */ "./src/mock/trip-point.js");
/* harmony import */ var _model_points_model_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/points-model.js */ "./src/model/points-model.js");
/* harmony import */ var _model_filters_model_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/filters-model.js */ "./src/model/filters-model.js");
...
}, _mock_trip_point__WEBPACK_IMPORTED_MODULE_4__.generatePoint);
const pageMainElement = document.querySelector('.page-body');
const tripControlsNavigationElement = document.querySelector('.trip-controls__navigation');
const tripControlsFiltersElement = document.querySelector('.trip-controls__filters');
const pointsModel = new _model_points_model_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
pointsModel.points = tripPoints;
const filterModel = new _model_filters_model_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
const tripPresenter = new _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_2__["default"](pageMainElement, pointsModel, filterModel);
const filterPresenter = new _presenter_filter_presenter_js__WEBPACK_IMPORTED_MODULE_3__["default"](tripControlsFiltersElement, filterModel);
